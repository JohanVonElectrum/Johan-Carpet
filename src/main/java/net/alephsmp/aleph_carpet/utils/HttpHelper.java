package net.alephsmp.aleph_carpet.utils;
...
public class HttpHelper {
    ...
    private static final String LATEST_RELEASE = "GET https://api.github.com/repos/AlephSMP/Aleph-Carpet/releases/latest";
    ...
    public static String getLatestRelease() {
        ...
        try {
            ...
            response = AlephExtension.VERSION;
        }
        return response;
    }
